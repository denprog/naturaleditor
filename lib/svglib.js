...
var SvgLib = Class.extend(
	{
		...
		rect : function(x, y, width, height, color, parentTag)
		{
			...
			rectObj.setAttribute("style", "shape-rendering:crispEdges; stroke:" + color + "; stroke-width:1; fill:none");
		...
		fillRect : function(x, y, width, height, fillColor, parentTag)
		{
			...
			rectObj.setAttribute("style", "shape-rendering:crispEdges; stroke:" + fillColor + "; stroke-width:1; fill:" + fillColor);
