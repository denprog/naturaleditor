 ...
 * @constructor
 */
var SuperscriptFormulaNode = CompoundFormulaNode.extend(
	{
		init : function(parentNode, pos, nte)
		{
			...
			this.className = "SuperscriptFormulaNode";
		...
		{
			var resNode = new SuperscriptFormulaNode(parent, this.parentNode == null ? 0 : this.parentNode.getChildPos(this), this.nte);
