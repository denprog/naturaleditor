...
var ForeignTextFormulaNode = ForeignObjectFormulaNode.extend(
	{
		...
		createChildNode : function(nodeClassType, pos)
		{
			if (nodeClassType == window["SpanNode"])
				return new ForeignFormulaSpanNode(this, pos, this.nte);
		...
		{
			var resNode = new ForeignTextFormulaNode(parent, this.parentNode.getChildPos(this), this.nte);
...
var ForeignFormulaSpanNode = HtmlNode.extend(
	{
		init : function(parentNode, pos, nte)
		{
			if (parentNode)
			...
			this.className = "ForeignFormulaSpanNode";
		...
		addTextNode : function(textNode)
		{
			if (this.isEmpty())
				this.childNodes.reset();
			new ForeignFormulaTextNode(textNode, this, this.childNodes.count(), this.nte);
		},

		createChildNode : function(nodeClassType, pos)
		{
			if (nodeClassType == window["TextNode"])
				return new ForeignFormulaTextNode(null, this, pos, this.nte);
			return new nodeClassType(this, pos, this.nte);
		}, 
...
var ForeignFormulaTextNode = TextNode.extend(
	{
		init : function(textNode, parentNode, pos, nte)
		{
			...
			this.className = "ForeignFormulaTextNode";
		},
		...
		dublicate : function(parent)
		{
			...
			var resNode = new ForeignFormulaTextNode(t, parent, this.parentNode.getChildPos(this), this.nte);
			resNode.caretState = this.caretState;
